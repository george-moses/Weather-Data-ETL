...
Traceback (most recent call last):
  File "/home/ubuntu/airflow/dags/weather_dag.py", line 81, in <module>
    transform_load_weather_data = PythonOperator(
  File "/usr/local/lib/python3.10/dist-packages/airflow/models/baseoperator.py", line 429, in apply_defaults
    result = func(self, **kwargs, default_args=default_args)
  File "/usr/local/lib/python3.10/dist-packages/airflow/operators/python.py", line 166, in __init__
